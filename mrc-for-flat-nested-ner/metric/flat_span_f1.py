...
def bmes_decode(char_label_list: List[Tuple[str, str]]) -> Tuple[str, List[Tag]]:
    ...
    while idx < length:
        ...
        # correct labels
        if idx == 0 and (current_label == "E" or current_label == "M"):
            current_label = "B"
        if idx > 0 and (char_label_list[idx-1][1][0] == "O" or char_label_list[idx-1][1][0] == "E" or char_label_list[idx-1][1][0] == "S") and (current_label == "E" or current_label == "M"):
            current_label = "B"
        ...
        if current_label == "B":
            ...
            print(idx, current_label, char_label_list)
            continue 
